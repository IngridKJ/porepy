...
# Mortar_discr represents kappa/mu in Eq. 3.3.
edge_equation: pp.ad.Operator = (
    edge_discretization.mortar_discr
    * (
...
eq_manager.equations = [node_equation, edge_equation]
